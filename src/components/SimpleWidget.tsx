...
export const SimpleWidget = ({title,subTitle,label,icon, href}:Props) => {
    return (
        <div className="bg-white shadow-xl m-2 p-3 sm:min-w-[25%] min-w-full  rounded-2xl border-1 border-gray-50 mx-2">
                ...
                <div className="my-3">
                    <div className="flex flex-row items-center justify-center space-x-1 ">
                        ...
                        <div id="temp" className="text-center">
                            <h4 className="text-4xl text-gray-500">{subTitle}</h4>
